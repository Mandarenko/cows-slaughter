        ...
        header: Column {
            ...
            Row {
                ...
                IconButton {
                    ...
                    onClicked: checkNumber([repeater.itemAt(0).children[0].text, repeater.itemAt(1).children[0].text, repeater.itemAt(2).children[0].text, repeater.itemAt(3).children[0].text])
                }
            }
        }
